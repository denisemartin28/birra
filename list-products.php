  ...
  <div class="row">
    <div class="col-xs-6 col-sm-4 col-md-4 col-lg-4 col-xl-4">
      <div class="panel panel-default text-center mt-3" >
        ...
        <div class="panel-footer"><a class="more" class="stretched-link" href="articles.php#1">Ver más</a></div>
      </div>
    </div>
    <div class="col-xs-6 col-sm-4 col-md-4 col-lg-4 col-xl-4">
      <div class="panel panel-default text-center mt-3">
        ...
        <div class="panel-footer" class="footer"><a class="more stretched-link" href="articles.php#2">Ver más</a></div>
      </div>
    </div>
    <div class="col-xs-6 col-sm-4 col-md-4 col-lg-4 col-xl-4">
      <div class="panel panel-default text-center mt-3">
        ...
        <div class="panel-footer"><a class="more stretched-link" href="articles.php#3">Ver más</a></div>
      </div>
    </div>
  </div>
</div><br>
  ...
  <div class="row">
    <div class="col-xs-6 col-sm-4 col-md-4 col-lg-4 col-xl-4">
      <div class="panel panel-default text-center mt-3">
        ...
        <div class="panel-footer"><a class="more stretched-link" href="articles.php#4">Ver más</a></div>
      </div>
    </div>
    <div class="col-xs-6 col-sm-4 col-md-4 col-lg-4 col-xl-4">
      <div class="panel panel-default text-center mt-3">
        ...
        <div class="panel-footer"><a class="more stretched-link" href="articles.php#5">Ver más</a></div>
      </div>
    </div>
